                ...
                a(".drag-target").on("click", function() { c() }), a(".drag-target").hammer({ prevent_default: !1 }).bind("pan", function(d) {
                    if ("touch" == d.gesture.pointerType) {
                        ...
                        if (0 === a("#sidenav-overlay").length) {
                            ...
                            h.css("opacity", 0).click(function() { c() }), a("body").append(h) }
                        ...
                        else { f < a(window).width() - b.menuWidth / 2 ? g = !0 : f >= a(window).width() - b.menuWidth / 2 && (g = !1);
                            var i = -1 * (f - b.menuWidth / 2);
                            i > 0 && (i = 0), e.css("right", i) } "left" === b.edge ? (overlayPerc = f / b.menuWidth, a("#sidenav-overlay").velocity({ opacity: overlayPerc }, { duration: 50, queue: !1, easing: "easeOutQuad" })) : (overlayPerc = Math.abs((f - a(window).width()) / b.menuWidth), a("#sidenav-overlay").velocity({ opacity: overlayPerc }, { duration: 50, queue: !1, easing: "easeOutQuad" })) } }).bind("panend", function(c) {
                    if ("touch" == c.gesture.pointerType) {
                        var d = c.gesture.velocityX;
                        f = !1, "left" === b.edge ? g && .3 >= d || -.5 > d ? (e.velocity({ left: 0 }, { duration: 300, queue: !1, easing: "easeOutQuad" }), a("#sidenav-overlay").velocity({ opacity: 1 }, { duration: 50, queue: !1, easing: "easeOutQuad" }), a(".drag-target").css({ width: "50%", right: 0, left: "" })) : (!g || d > .3) && (e.velocity({ left: -1 * (b.menuWidth + 10) }, { duration: 200, queue: !1, easing: "easeOutQuad" }), a("#sidenav-overlay").velocity({ opacity: 0 }, { duration: 200, queue: !1, easing: "easeOutQuad", complete: function() { a(this).remove() } }), a(".drag-target").css({ width: "10px", right: "", left: 0 })) : g && d >= -.3 || d > .5 ? (e.velocity({ right: 0 }, { duration: 300, queue: !1, easing: "easeOutQuad" }), a("#sidenav-overlay").velocity({ opacity: 1 }, { duration: 50, queue: !1, easing: "easeOutQuad" }), a(".drag-target").css({ width: "50%", right: "", left: 0 })) : (!g || -.3 > d) && (e.velocity({ right: -1 * (b.menuWidth + 10) }, { duration: 200, queue: !1, easing: "easeOutQuad" }), a("#sidenav-overlay").velocity({ opacity: 0 }, { duration: 200, queue: !1, easing: "easeOutQuad", complete: function() { a(this).remove() } }), a(".drag-target").css({ width: "10px", right: 0, left: "" })), a("body").addClass("overflow-no") } }), d.click(function() {
                    if (g === !0) g = !1, f = !1, c();
                    else { a("body").addClass("overflow-no"), "left" === b.edge ? (a(".drag-target").css({ width: "50%", right: 0, left: "" }), e.velocity({ left: 0 }, { duration: 300, queue: !1, easing: "easeOutQuad" })) : (a(".drag-target").css({ width: "50%", right: "", left: 0 }), e.velocity({ right: 0 }, { duration: 300, queue: !1, easing: "easeOutQuad" }), e.css("left", ""));
                        var d = a('<div id="sidenav-overlay"></div>');
                        d.css("opacity", 0).click(function() { g = !1, f = !1, c(), d.velocity({ opacity: 0 }, { duration: 300, queue: !1, easing: "easeOutQuad", complete: function() { a(this).remove() } }) }), a("body").append(d), d.velocity({ opacity: 1 }, { duration: 300, queue: !1, easing: "easeOutQuad", complete: function() { g = !0, f = !1 } }) }
...
function(a, b, c, d) { "use strict";
    ...
    function e(b, c) { g = this, this.element = a(b), this.options = a.extend({}, h, c), this._defaults = h, this._name = f, this.init() }
    var f = "ripples",
        g = null,
        h = {};
    e.prototype.init = function() {
        ...
        c.on("mousedown touchstart", function(d) {
            if (!g.isTouch() || "mousedown" !== d.type) { c.find(".ripple-wrapper").length || c.append('<div class="ripple-wrapper"></div>');
                ...
                if (f || h) {
                    var i = g.getRipplesColor(c),
                        j = a("<div></div>");
                    j.addClass("ripple").css({ left: h, top: f, "background-color": i }), e.append(j),
                        function() {
                            return b.getComputedStyle(j[0]).opacity }(), g.rippleOn(c, j), setTimeout(function() { g.rippleEnd(j) }, 500), c.on("mouseup mouseleave touchend", function() { j.data("mousedown", "off"), "off" === j.data("animating") && g.rippleOut(j) }) } } }) }, e.prototype.getNewSize = function(a, b) {
        return Math.max(a.outerWidth(), a.outerHeight()) / b.outerWidth() * 2.5 }, e.prototype.getRelX = function(a, b) {
        var c = a.offset();
        return g.isTouch() ? (b = b.originalEvent, 1 !== b.touches.length ? b.touches[0].pageX - c.left : !1) : b.pageX - c.left }, e.prototype.getRelY = function(a, b) {
        var c = a.offset();
        return g.isTouch() ? (b = b.originalEvent, 1 !== b.touches.length ? b.touches[0].pageY - c.top : !1) : b.pageY - c.top }, e.prototype.getRipplesColor = function(a) {
        var c = a.data("ripple-color") ? a.data("ripple-color") : b.getComputedStyle(a[0]).color;
        return c }, e.prototype.hasTransitionSupport = function() {
        var a = c.body || c.documentElement,
            b = a.style,
            e = b.transition !== d || b.WebkitTransition !== d || b.MozTransition !== d || b.MsTransition !== d || b.OTransition !== d;
        return e }, e.prototype.isTouch = function() {
        return /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) }, e.prototype.rippleEnd = function(a) { a.data("animating", "off"), "off" === a.data("mousedown") && g.rippleOut(a) }, e.prototype.rippleOut = function(a) { a.off(), g.hasTransitionSupport() ? a.addClass("ripple-out") : a.animate({ opacity: 0 }, 100, function() { a.trigger("transitionend") }), a.on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function() { a.remove() }) }, e.prototype.rippleOn = function(a, b) {
        var c = g.getNewSize(a, b);
        g.hasTransitionSupport() ? b.css({ "-ms-transform": "scale(" + c + ")", "-moz-transform": "scale(" + c + ")", "-webkit-transform": "scale(" + c + ")", transform: "scale(" + c + ")" }).addClass("ripple-on").data("animating", "on").data("mousedown", "on") : b.animate({ width: 2 * Math.max(a.outerWidth(), a.outerHeight()), height: 2 * Math.max(a.outerWidth(), a.outerHeight()), "margin-left": -1 * Math.max(a.outerWidth(), a.outerHeight()), "margin-top": -1 * Math.max(a.outerWidth(), a.outerHeight()), opacity: .2 }, 500, function() { b.trigger("transitionend") }) }, a.fn.ripples = function(b) {
        return this.each(function() { a.data(this, "plugin_" + f) || a.data(this, "plugin_" + f, new e(this, b)) }) } }(jQuery, window, document);
var theme_colors = { "brand-primary": "blue", "brand-success": "green", "brand-info": "purple", "brand-warning": "orange", "brand-danger": "red", theme: "pink", "theme-secondary": "blue" },
...
$(function() { $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), $(".navbar-toggle").sideNav({ menuWidth: 260, closeOnClick: !0 });
...
$(function() {
    if ($(".charts").length > 0) { colors = ["#4CAF50", "#2196F3", "#9c27b0", "#ff9800", "#F44336"], guage_options = { data: { columns: [
        ...
        var d = c3.generate(a),
            e = c3.generate(b),
            f = c3.generate(c);
        interval = setInterval(function() { d.load({ columns: [
        ...
        c3.generate({ bindto: "#line-chart", data: { columns: [
                    ["data1", 30, 200, 100, 400, 150, 250],
                    ["data2", 50, 20, 10, 40, 15, 25]
                ] }, color: { pattern: colors } });
        c3.generate({ bindto: "#area-chart", data: { columns: [
                    ["data1", 300, 350, 300, 0, 0, 0],
                    ["data2", 130, 100, 140, 200, 150, 50]
                ], types: { data1: "area", data2: "area-spline" } }, color: { pattern: colors } }), c3.generate({ bindto: "#bar-chart", data: { columns: [
                    ["data1", 30, 200, 100, 400, 150, 250],
                    ["data2", 130, 100, 140, 200, 150, 50],
                    ["data3", 30, 200, 100, 400, 150, 250]
                ], type: "bar" }, bar: { width: { ratio: .5 } }, color: { pattern: colors } }), c3.generate({ bindto: "#step-chart", data: { columns: [
                    ["data1", 300, 350, 300, 0, 0, 100],
                    ["data2", 130, 100, 140, 200, 150, 50]
                ], types: { data1: "step", data2: "area-step" } }, color: { pattern: colors } }), c3.generate({ bindto: "#scatter-plot-chart", data: { xs: { setosa: "setosa_x", versicolor: "versicolor_x" }, columns: [
...
randomData = function(a, b, c) {
    ...
    return data }, chartData1 = randomData(20, 40, 60), chartData2 = randomData(20, 40, 60), chartData3 = randomData(20, 40, 60), chartData4 = randomData(100, 10, 30), chartData1.unshift("Sales"), chartData2.unshift("Customers"), chartData3.unshift("Signups"), chartData4.unshift("Customers"), serverLoadOptions = { bindto: "#server-load-chart", legend: { show: !1 }, padding: { top: 6, right: -1, bottom: -8, left: 0 }, data: { columns: [
            ["Server load"].concat(values)
        ], type: "area" }, size: { height: 160 }, axis: { x: { show: !1, padding: { left: 0, right: 0 } }, y: { show: !1, max: 100, min: 0, padding: { top: 0, bottom: 0 } } }, grid: { focus: { show: !1 } }, point: { show: !1 }, tooltip: { format: { title: function(a) {}, value: function(a, b, c) {
                return a + "%" } } }, transition: { duration: 50 } };
var chartLine1 = { bindto: "#chart-line-1", data: { columns: [chartData1] }, axis: { x: { show: !1 }, y: { show: !1 } }, color: { pattern: ["#fff"] }, legend: { hide: !0 }, size: { height: 100 } },
    chartLine2 = { bindto: "#chart-line-2", data: { columns: [chartData2] }, axis: { x: { show: !1 }, y: { show: !1 } }, color: { pattern: ["#fff"] }, legend: { hide: !0 }, size: { height: 100 } },
    chartLine3 = { bindto: "#chart-line-3", data: { columns: [chartData3] }, axis: { x: { show: !1 }, y: { show: !1 } }, color: { pattern: ["#fff"] }, legend: { hide: !0 }, size: { height: 100 } },
    chartArea1 = { bindto: "#chart-area-1", data: { columns: [chartData4], types: { Customers: "area" } }, axis: { x: { show: !1 }, y: { show: !1 } }, color: { pattern: ["#EC407A"] }, legend: { hide: !0 }, size: { height: 100 }, padding: { right: -18, bottom: -28, left: -18 } },
    chartGauge1 = { bindto: "#chart-gauge-1", data: { columns: [
                ["data", 80]
            ], types: { data: "gauge" } }, gauge: { width: 3 }, color: { pattern: ["#E91E63"] }, legend: { hide: !0 }, tooltip: { show: !1 }, size: { height: 80 } },
    chartGauge2 = { bindto: "#chart-gauge-2", data: { columns: [
                ["data", 30]
            ], types: { data: "gauge" } }, gauge: { width: 3 }, color: { pattern: ["#E91E63"] }, legend: { hide: !0 }, tooltip: { show: !1 }, size: { height: 80 } },
    chartGauge3 = { bindto: "#chart-gauge-3", data: { columns: [
                ["data", 40]
            ], types: { data: "gauge" } }, gauge: { width: 3 }, color: { pattern: ["#E91E63"] }, legend: { hide: !0 }, tooltip: { show: !1 }, size: { height: 80 } },
    chartPageviews = { bindto: "#chart-pagesviews", data: { columns: [
                ["Pageviews", 3, 4, 5, 10, 20, 14, 18, 12, 10, 20, 10, 14, 15, 10, 20, 14, 18, 12, 10, 20]
            ], types: { Pageviews: "area" } }, axis: { x: { show: !1 }, y: { show: !1 } }, color: { pattern: ["#fff"] }, legend: { hide: !0 }, size: { height: 100 } };
$(".dashboard").length > 0 && (c3.generate(serverLoadOptions), c3.generate(chartLine1), c3.generate(chartLine2), c3.generate(chartLine3), c3.generate(chartArea1), c3.generate(chartGauge1), c3.generate(chartGauge2), c3.generate(chartGauge3), c3.generate(chartPageviews)), $(function() {
        if ($("#full-map-canvas").length > 0 && new GMaps({ div: "#full-map", lat: 45, lng: -73, zoom: 8, width: "100%", height: "100%" }), $(".maps-widgets").length > 0) { new GMaps({ div: "#map-basic", lat: 45, lng: -73, zoom: 8, height: "350px" });
            var a = new GMaps({ div: "#map-zoomable", lat: 52.369371, lng: 4.894494, zoom: 8, height: "350px" });
            $("#slider").on({ slide: function(b, c) { a.setZoom(parseInt(c)) } }), start = $("#slider").data("start"), min = $("#slider").data("min"), max = $("#slider").data("max"), $("#slider").noUiSlider({ start: start, step: 0, range: { min: [min], max: [max] } });
            var b = new GMaps({ div: "#map-searchable", lat: 40.399516, lng: -22.703348, zoom: 2, height: "350px" });
            $("#card-map-searchable button").click(function(a) { a.preventDefault(), GMaps.geocode({ address: $("#card-map-searchable input").val().trim(), callback: function(a, c) {
                        if ("OK" == c) {
                            var d = a[0].geometry.location;
                            b.setCenter(d.lat(), d.lng()), b.addMarker({ lat: d.lat(), lng: d.lng() }) } } }) });
            var c = new GMaps({ div: "#map-clickable", lat: 45, lng: -73, zoom: 2, height: "350px" }),
                d = [];
            d.push({ id: 0, lat: 52.369371, lng: 4.894494, title: "Amsterdam" }), d.push({ id: 1, lat: 40.712942, lng: -74.005774, title: "New York" }), d.push({ id: 2, lat: 41.385196, lng: 2.173315, title: "Barcelona" }), d.push({ id: 3, lat: 37.764355, lng: -122.451954, title: "San Francisco" }), c.addMarkers(d), $("#card-map-clickable .btn-group .btn").click(function() { index = $(this).find("input").val();
        ...
        var d = function(a, c) { "use strict";
            a.extend(!0, c.defaults, { dom: "<'row'<'col-sm-6'l><'col-sm-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>", renderer: "bootstrap" }), a.extend(c.ext.classes, { sWrapper: "dataTables_wrapper form-inline dt-bootstrap", sFilterInput: "form-control input-sm", sLengthSelect: "form-control input-sm" }), c.ext.renderer.pageButton.bootstrap = function(d, e, f, g, h, i) {
                var j, k, l, m = new c.Api(d),
                    ...
                    p = 0,
                    q = function(b, c) {
                        var e, g, l, r, s = function(b) { b.preventDefault(), a(b.currentTarget).hasClass("disabled") || m.page(b.data.action).draw(!1) };
...
$('.messages button[bs-modal="modal"]').on("click", function(a) { $("#exampleModal").remove();
    var b = $(modal_content);
    $("body").append(b), $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), b.modal({ backdrop: "static", keyboard: !1 }) });
